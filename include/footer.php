                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-6">
                            <div class="widget widget-about">
                                ...
                                <img src="assets\images\logo2.png" alt="" class="img-l"> 
                                <h4>Areas We Deliver</h4>
                                <!-- <h3>Thane</h3> -->
                                <!-- <p>Goa <br> Mumbai <br> Pune <br> Delhi</p> -->
                                <p class="p-location">Goa</p>
                                <p class="p-location">Mumbai</p>
                                <p class="p-location">Pune</p>
                                <p class="p-location">Delhi</p>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="widget widget-contact text-center">
                                ...
                                <a href="tel://9578472625"><strong>+91 95784 72625</strong></a>
            ...
            <div class="bottom-footer">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="copyright">
                                <p>Copyright 2020 © All Rights Reserved. Infoter Solutions</p>
                            </div><!--copyright end-->
                        </div>
                        <div class="col-lg-6">
